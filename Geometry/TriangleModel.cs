...
namespace Geometry
{
    ...
    public partial class TriangleModel : ObservableObject, IShape
    {
        ...
        [JsonConstructor]
        public TriangleModel(float angle, float centerX, float centerY, float strokeThickness, Color fill, Color stroke, float width, float height, float boxWidth, float boxHeight, float boxCenterX, float boxCenterY, ObservableCollection<Point> listOfPoints)
        {
            _angle = angle;
            _centerX = centerX;
            _centerY = centerY;
