...
namespace Geometry
{
    ...
    public partial class HexagonModel : ObservableObject, IShape
    {
        ...
        [JsonConstructor]
        public HexagonModel(float angle, float centerX, float centerY, float strokeThickness, Color fill, Color stroke, float width, float height, float boxWidth, float boxHeight, float boxCenterX, float boxCenterY, ObservableCollection<Point> listOfPoints)
        {
            _angle = angle;
            _centerX = centerX;
            _centerY = centerY;
        ...
        public HexagonModel()
        {
            ListOfPoints = new() {
                ...
                new Point(CenterX + Width / 2.0, CenterY - Height / 4.0),
                new Point(CenterX + Width / 2.0, CenterY + Height / 4.0),
                new Point(CenterX, CenterY + Height / 2.0),
                new Point(CenterX - Width / 2.0, CenterY + Height / 4.0),
                new Point(CenterX - Width / 2.0, CenterY - Height / 4.0)
